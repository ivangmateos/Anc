        ...
        <section>
            <div class="jumbotron pt-5">
                <div class="container contenedorletras">
                    ...
                    <p>Aqui podras añadir un producto
                    </p>
                </div>
            </div>
        </section>
                            ...
                            <form action="../Php/Registro_Producto.php" method="post" enctype="multipart/form-data">
                                <div class="datosdelproducto">
                                    ...
                                    <?php if (isset($_GET["error"])) {
                                        echo "<span class='text-danger mt-4 error'>El producto ya existe </span>";
                                    } ?>
                                    <div class="form-group pt-1">
                                        <label for="inputnombre" title="Obligatorio">Nombre*</label>
                                        <input type="text" class="form-control" id="nombre" name="inputnombre" pattern="[^\s][a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ]+[,a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{3,30}" placeholder="Correa" required>
                                        <p id="ErrorNombre" class="letrasvalidacion"></p>
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="inputprecio" title="Obligatorio">Precio*</label>
                                        <input type="number" class="form-control" id="precio" name="inputprecio" step="0.01" placeholder="25,30" required>
