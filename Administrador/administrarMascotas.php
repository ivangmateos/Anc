...
<body class="bodyadmin">
    ...
    <header>
        ...
        <section class="wrap" id="admin-course">
            <div class="container">
                <h1>Administracion de las Mascotas</h1>
                <p class="lead">Aqui podras añadir, editar y borrar mascotas</p>
                <?php if (isset($_GET["Mascota_Modificada"])) {
                    echo "<span class='text-success mt-4 mascotamodificada'>Mascota Modificada</span>";
                } ?>
                <?php if (isset($_GET["Mascota_Registrada"])) {
                    echo "<span class='text-success mt-4 mascotamodificada'>Mascota Registrada</span>";
                } ?>
                <?php if (isset($_GET["Mascota_Eliminada"])) {
                    echo "<span class='text-success mt-4 mascotamodificada'>La mascota " . $_SESSION['mascotaeliminada'] . " se ha eliminado</span>";
                } ?>
                <div class="row comentario">
                    <div class="col-sm-12  mt-2">
                        <a href="../Administrador/añadirMascota.php" class='btn  btn-success btn-block col-12 mb-2'>Añadir mascota</a>
                        <!--MOSTRAR TODAS LAS MASCOTAS-->
                        <?php
                        Metodos_Mascotas::get_Mascotas();
