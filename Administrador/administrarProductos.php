...
<body class="bodyadmin">
    ...
    <header>
        ...
        <section class="wrap" id="admin-course">
            <div class="container">
                <h1>Administracion de los productos</h1>
                <p class="lead">Aqui podras añadir, editar y borrar productos</p>
                <?php if (isset($_GET["Producto_Modificado"])) {
                    echo "<span class='text-success mt-4 productomodificado'>Producto Modificado</span>";
                } ?>
                <?php if (isset($_GET["Producto_Registrado"])) {
                    echo "<span class='text-success mt-4 productomodificado'>Producto Registrado</span>";
                } ?>
                <?php if (isset($_GET["Producto_Eliminado"])) {
                    echo "<span class='text-success mt-4 productomodificado'>El producto " . $_SESSION['productooeliminado'] . " se ha eliminado</span>";
                } ?>
                <div class="row comentario">
                    <div class="col-sm-12  mt-2">
                        <a href="../Administrador/añadirProducto.php" class='btn  btn-success btn-block col-12 mb-2'>Añadir productos</a>
                        <!--MOSTRAR TODOS LOS Productos-->
                        <?php
                        Metodos_Productos::get_Productos2();
