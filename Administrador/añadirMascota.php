        ...
        <section>
            <div class="jumbotron pt-5">
                <div class="container contenedorletras">
                    ...
                    <p>Aqui podras registrar a una mascota
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="modal-body borde">
                            <form action="../Php/Registro_Mascotas.php" method="post" enctype="multipart/form-data">
                                <div class="datosbasicos">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number" class="form-control" id="edad" name="inputedad" min="0" max="20" placeholder="2" required>
