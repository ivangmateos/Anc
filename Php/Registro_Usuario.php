 ...
 */
    ...
    if (isset($_POST["inputnombre"])){
        ...
        try {
            ...
            header("location:../index.php?Usuario_Registrado");
        }catch (PDOException $e){
            //si salta la excepci�n es porque el nombre de usuario ya existe, as� que vuelvo a la vista y muestro un mensaje de error
            $error = "El_nombre_de_usuario_ya_existe"; 
            header("location:../Sinacceder/Registro.php?error=$error");
        }
    }
?>
